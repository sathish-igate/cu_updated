...
$conf['pub_site_shortname'] = 'nbcuunite';
...
elseif (in_array($_ENV['AH_SITE_ENVIRONMENT'], array('dev'))) {
  $env = 'dev';
}
elseif (in_array($_ENV['AH_SITE_ENVIRONMENT'], array('acc', 'qa'))) {
  $env = 'qa';
}
elseif (in_array($_ENV['AH_SITE_ENVIRONMENT'], array('stage', 'test', 'tmp'))) {
  $env = 'stage';
}
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/nbcuunite/nbcuunite-settings.inc';
}
