...
s.linkInternalFilters="javascript:,empathylab.com,nbcuots.com,nbcuni.com,mun2.tv,telemundo.com,bravotv.com,usanetwork.com,oxygen.com,syfy.com,eonline.com,style.com,g4tv.com,sproutonline.com";
...
function s_doPlugins(s) {
  ...
  //Props
  if (s.channel) { s.prop3 = s.channel; }
  if (typeof(syfy_affinityOmnitureProp1) != 'undefined') {s.prop1 = syfy_affinityOmnitureProp1;}
  ...
  s.eVar24 = s.getQueryParam('o,ref_type',':');
  ...
  if(s.exit){s.eVar24 = s.getQueryParam('o,ref_type',':',s.exit);s.campaign=s.getQueryParam('cid,__source',':',s.exit);
