...
class Manager {
  ...
  /**
  * Helper method for getting the root Condition.
  *
  * The Root condition is used as the basis for the constructing the preview
  * form. It can be expected that it will be much more complicated than the
  * other conditions.
  *
  * This method selects the condition and its configuration using the
  * config_controller().
  *
