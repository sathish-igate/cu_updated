...
include_once DRUPAL_ROOT . '/profiles/publisher/modules/custom/pub_sso/lib/config.inc';
...
$config = array (
	...
	'admin.protectindexpage' => $environment_config['admin.protectindexpage'],
	'admin.protectmetadata'	=> $environment_config['admin.protectmetadata'],
	...
	'logging.handler' => $environment_config['logging.handler'],
	/*
